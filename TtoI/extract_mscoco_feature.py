...
def main(resolution=256):
    ...
    if args.split == "train":
        datas = MSCOCODatabase(root='assets/datasets/coco/train2017',
                             annFile='assets/datasets/coco/annotations/captions_train2017.json',
                             size=resolution)
        save_dir = f'assets/datasets/coco{resolution}_features/train'
    elif args.split == "val":
        datas = MSCOCODatabase(root='assets/datasets/coco/val2017',
                             annFile='assets/datasets/coco/annotations/captions_val2017.json',
                             size=resolution)
